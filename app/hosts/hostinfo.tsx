		...
		<div className="bg-white px-6 py-32 lg:px-8">
			<div className="mx-auto max-w-3xl text-base leading-7 text-gray-700">
				...
				<p className="mt-6 text-xl leading-8">
					...
					government-verified ID with you, and a live video recording
					so that we know you are a real person. You will then be
					matched with refuge-seekers through one of our humanatarian
					partners.
				</p>
				<div className="mt-10 max-w-2xl">
					<p>
						Your data always belongs to you. We will never sell,
